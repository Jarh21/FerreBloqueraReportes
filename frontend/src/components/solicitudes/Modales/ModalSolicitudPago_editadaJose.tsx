...
import SelectConcepto from '../../selectoresContables/SelectConcepto';
const TIPOS_PAGO = {
  BINANCE: "BINANCE",
  ...
  const renderConceptoInput = () => {
      ...
      return (
          <div className="space-y-1">
            ...
            <SelectConcepto value={Number(formData.concepto)} onChange={(value) => setFormData({...formData, concepto: value?.toString() || ''})} />
          </div>
      );
  };
